...
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-light">Lista Proveedores</h6>
        ...
        <button class="btn btn-primary btn-sm" style="float:right" onclick="nuevo()"><i class="fa fa-file-alt"></i> NUEVO</button>
                                ...
                                <!-- Card Body -->
                                <div class="card-body" style="height: 423px;overflow: auto;">
                                    ...
                                    <div class="form-group">
                                        <label>RUC</label>
                                       <input type="text" class="form-control form-control-user" id="txtruc" placeholder="">
                                    </div>
...
<script src="plantilla/js/seguridad.js"></script>
    ...
    <script>
        ...
        function detalle(id){
            var url = "postdetalleproveedor.jsp";
             $.ajax({
                    url: url,
                    type: "POST",
                    data: {id:id},
                    ...
                    success: function (response) {
                        var texto = response.trim();
                        var objproveedores = jQuery.parseJSON(texto);  
                        console.log(objproveedores);
                        $("#txtid").val(objproveedores.id);
                        $("#txtnombre").val(objproveedores.nombre);
                        $("#txtruc").val(objproveedores.ruc);
                        if(objproveedores.estado==="1"){
         ...
         function nuevo(){
          ...
          function guardar(){
            ...
            var url = "postguardarproveedor.jsp";
             $.ajax({
                    url: url,
                    type: "POST",
                    data: {id:id,nombre:nombre,ruc:ruc,estado:estado},
                    contentType: "application/x-www-form-urlencoded",
                    success: function (response) {
                        var texto = response.trim();
