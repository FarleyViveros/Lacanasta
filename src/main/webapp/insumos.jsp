...
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-light">Lista Insumos</h6>
        ...
        <button class="btn btn-primary btn-sm" style="float:right" onclick="nuevo()"><i class="fa fa-file-alt"></i> NUEVO</button>
                                ...
                                <!-- Card Body -->
                                <div class="card-body" style="height: 425px;overflow: auto;">
        ...
        function detalle(id){
            var url = "postdetalleinsumos.jsp";
             $.ajax({
                    ...
                    success: function (response) {
                        ...
                        console.log(objinsumos);
                        $("#txtid").val(objinsumos.id);
                        $("#txtnombre").val(objinsumos.nombre);
                        $("#txtprecio").val(objinsumos.precio);
                        $("#txtcantidad").val(objinsumos.cantidad);
                        $("#txtunidad").val(objinsumos.unidad);
                        if(objinsumos.estado==="1"){
         ...
         function nuevo(){
          ...
          function guardar(){
            ...
            var url = "postguardarinsumos.jsp";
             $.ajax({
                    url: url,
                    type: "POST",
                    data: {id:id,nombre:nombre,precio:precio,unidad:unidad,cantidad:cantidad,estado:estado},
                    contentType: "application/x-www-form-urlencoded",
                    success: function (response) {
                        var texto = response.trim();
