...
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-light">Producto de la Carta </h6>
        ...
        <button class="btn btn-primary btn-sm" style="float:right" onclick="nuevo()"><i class="fa fa-file-alt"></i> NUEVO</button>
                                ...
                                <!-- Card Body -->
                                <div class="card-body" style="height: 427px;overflow: auto;">
                                    ...
                                    <div class="form-group">
                                        <label>ESTADO</label>
                                        <input type="checkbox" class="form-control" style="width: 46px;" checked="checked" id="chkestado">
                                    </div>
        ...
        function detalle(id){
            var url = "postdetallecarta.jsp";
             $.ajax({
                    ...
                    success: function (response) {
                        var texto = response.trim();
                        var objcarta = jQuery.parseJSON(texto);  
                        console.log(objcarta);
                        $("#txtid").val(objcarta.id);
                        $("#txtnombre").val(objcarta.nombre);
                        $("#txtprecio").val(objcarta.precio);
                        if(objcarta.estado==="1"){
         ...
         function nuevo(){
          ...
          function guardar(){
            ...
            var url = "postguardarcarta.jsp";
             $.ajax({
                    url: url,
                    type: "POST",
                    data: {id:id,nombre:nombre,precio:precio,estado:estado},
                    contentType: "application/x-www-form-urlencoded",
                    success: function (response) {
                        var texto = response.trim();
